...
class ICaRL(nn.Module):
    def __init__(self, feature_size, n_classes,
        ...
        self.class_loss, self.dist_loss = self.build_loss(
    ...
    def COS_classify(self, batch_imgs):
        ...
        means_exemplars = means_exemplars.transpose(
            1, 2)  # means no normalized
        ...
        if self.herding:
            ...
            with torch.no_grad():
                for _, images, labels in loader:
                    ...
                    feature = feature / \
                        np.linalg.norm(feature.cpu())  # Normalize
            ...
            class_mean = class_mean / \
                np.linalg.norm(class_mean.cpu())  # Normalize
...
class ConcatDataset(Dataset):
    ...
    def __getitem__(self, index):
        if index < self.l1:
            # here it leans on cifar100 get item
